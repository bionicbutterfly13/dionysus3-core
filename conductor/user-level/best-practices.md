...
**User-level copy.** Install to `~/.claude/`, `~/.gemini/`, or `~/.codex/` so these practices apply to all projects. See `conductor/user-level/README.md` in this repo for install steps.
