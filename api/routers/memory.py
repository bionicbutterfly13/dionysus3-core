...
async def semantic_search(
    ...
    Searches memories using vector similarity against embeddings
    generated by Ollama (nomic-embed-text, 768 dimensions).

    The query is embedded and compared against stored memory embeddings
    using cosine similarity in Neo4j.
