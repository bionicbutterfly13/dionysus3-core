...
class DiscoveryOutput(BaseModel):
    count: int = Field(..., description="Total number of components discovered")
    top_n: int = Field(..., description="Number of results requested")
    results: List[ComponentAssessment] = Field(..., description="Serialized assessment details")
